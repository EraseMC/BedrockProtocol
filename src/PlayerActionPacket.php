...
class PlayerActionPacket extends DataPacket implements ClientboundPacket, ServerboundPacket{
	...
	protected function decodePayload(ByteBufferReader $in, int $protocolId) : void{
		...
		$this->resultPosition = $protocolId >= ProtocolInfo::PROTOCOL_1_19_0 ? CommonTypes::getBlockPosition($in, $protocolId >= ProtocolInfo::PROTOCOL_1_26_10) : $this->blockPosition;
